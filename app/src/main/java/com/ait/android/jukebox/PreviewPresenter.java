...
public class PreviewPresenter implements Preview.ActionListener {

    private static final String TAG = SearchPresenter.class.getSimpleName();
    public static final int PAGE_SIZE = 20;

    private final Context mContext;
    private final Preview.View mView;
    ...
    public PreviewPresenter(Context context, Preview.View view) {
        mContext = context;
        mView = view;
    }
